...
x3-pi-dockerx-build-push:
	docker buildx build --platform linux/arm64 -t huajuan6848/x3-54demo-ros-foxy:0.0.9-7-pi -f docker/x3/Dockerfile.pi --push .
x3-jetson-dockerx-build-push:
	docker buildx build --platform linux/arm64 -t huajuan6848/x3-54demo-ros-foxy:0.0.9-7-jetson -f docker/x3/Dockerfile.jetson --push .
